...
// File: contracts/contracts/Interfaces/IAerodrome.sol
...
// File: contracts/contracts/Interfaces/IMetaMorpho.sol
...
// File: contracts/contracts/Interfaces/IBundler.sol
...
// File: contracts/contracts/Interfaces/IERC20Extended.sol
...
// File: contracts/contracts/Interfaces/IMerklDistributor.sol
...
// File: contracts/contracts/userVaultV3Final.sol
...
// File: contracts/contracts/userVaultFacotory.sol
 ...
 * @dev Factory contract for deterministic cross-chain deployment of UserVault_V3 contracts using CREATE2
...
contract UserVaultFactory is Ownable, Pausable, ReentrancyGuard {
     ...
     * @param asset The primary asset (USDC) address for the vault
     * @param initialVaults Array of initial vault addresses
     * @param revenueAddress Address to receive fees
     * @param feePercentage Fee percentage in basis points
     * @param initialDepositAmount Initial deposit amount required
    ...
    function computeVaultAddress(
        ...
        bytes memory bytecode = abi.encodePacked(
            type(UserVault_V3).creationCode,
            abi.encode(
                owner,
                admin,
                asset,
    ...
    /**
     * @dev Deploy a new UserVault_V3 contract with deterministic address
     * @param owner The owner of the vault
     * @param admin The admin of the vault
     * @param asset The primary asset (USDC) address for the vault
     * @param initialVaults Array of initial vault addresses
    ...
    function deployVault(
        ...
        require(initialVaults.length > 0, "No initial vaults");
        require(revenueAddress != address(0), "Invalid revenue address");
        require(initialDepositAmount > 0, "Invalid initial deposit amount");
